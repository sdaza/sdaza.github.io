...
In this post I present a simple R package called [**sampler**](https://github.com/sdaza/sampler). The package defines **sample sizes** and **margins of error (MOE)** for a proportion, as usually is done when designing public opinion surveys. [In a previous post](https://sdaza.com/blog/2014/samplesize/), I presented some functions that do mostly the same thing. This new package, however, includes some new features that might be useful.
